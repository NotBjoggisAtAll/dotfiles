# fish completion for cli                                  -*- shell-script -*-
...
function __cli_perform_completion
    ...
    set -l requestComp "CLI_ACTIVE_HELP=0 $args[1] __complete $args[2..-1] $lastArg"
...
# this function limits calls to __cli_perform_completion, by caching the result behind $__cli_perform_completion_once_result
...
# this function is used to clear the $__cli_perform_completion_once_result variable after completions are run
...
# this will get called after the two calls below and clear the $__cli_perform_completion_once_result global
