...
function __fish_lsp_get_env_variables -d 'print all fish_lsp_* env variables, not yet used in the commandline'
    ...
    set -l env_names_with_descriptions "fish_lsp_enabled_handlers\t'server handlers to enable'" \
		...
		"fish_lsp_show_subcommand_semantic_tokens\t'Highlight `COMMAND SUBCOMMAND` tokens together'" \
		...
		"fish_lsp_tree_sitter_wasm_path\t'Override 'tree-sitter-fish.wasm' file used for parsing fish files'" \
...
#################################################################################
### generated output time:      7/31/26, 11:15:28 AM                          ###
### binary build time:          6/11/26, 4:38:37 AM                           ###
### binary build path:          ~/.local/bin/fish-lsp                         ###
### binary build version:       1.1.4                                         ###
